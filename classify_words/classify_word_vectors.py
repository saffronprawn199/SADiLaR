...
def print_report(y_pred, y_test, my_tags, name, output_file):
    """
...
def get_w2v_classifier(model, df, my_tags, output_file):
    ...
    :param output_file: output file name
    """
    y_pred, y_test = train_w2v_classifier(model, df)
    name = 'Classification model using W2V'
    print_report(y_pred, y_test, my_tags, name, output_file)
...
def get_baseline(df, my_tags, output_file):
    ...
    :param output_file: output file name
    """
    y_pred, y_test = train_baseline(df)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Classify pre-trained word embedding models \
